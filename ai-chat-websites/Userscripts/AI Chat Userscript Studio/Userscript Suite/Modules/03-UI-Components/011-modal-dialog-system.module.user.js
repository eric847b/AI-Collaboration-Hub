...
// @description  AI Chat Userscript Suite - Reusable modal framework
...
(() => {
    'use strict';
    const MODULE_NAME = 'modal-dialog-system';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '03-UI-Components' };
