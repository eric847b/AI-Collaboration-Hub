...
// @description  AI Chat Userscript Suite - Speech-to-text conversion
...
(() => {
    'use strict';
    const MODULE_NAME = 'audio-transcriber';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '09-Media' };
