...
// @description  AI Chat Userscript Suite - Learns from recurring errors
...
(() => {
    'use strict';
    const MODULE_NAME = 'error-pattern-detector';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '14-Error-Handling' };
