...
// @description  AI Chat Userscript Suite - Tracker and fingerprint protection
...
(() => {
    'use strict';
    const MODULE_NAME = 'privacy-guard';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '05-Security' };
