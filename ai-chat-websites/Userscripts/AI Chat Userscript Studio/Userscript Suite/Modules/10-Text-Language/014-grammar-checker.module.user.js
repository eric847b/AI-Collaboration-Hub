...
// @description  AI Chat Userscript Suite - Writing quality analysis
...
(() => {
    'use strict';
    const MODULE_NAME = 'grammar-checker';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '10-Text-Language' };
