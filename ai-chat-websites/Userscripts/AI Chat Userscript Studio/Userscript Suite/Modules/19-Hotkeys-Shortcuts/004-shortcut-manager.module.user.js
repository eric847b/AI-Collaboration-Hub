 ...
 * 2. Replace 49. Shortcut Manager .M and Custom keyboard shortcuts in metadata
...
(function() {
    ...
    const MODULE_ID = '49-shortcut-manager';
    const MODULE_NAME = 'Shortcut Manager';
    ...
    // Initialize module
    const instance = new ShortcutManagerModule();
    ...
    if (window.ModuleRegistry && typeof window.ModuleRegistry.register === 'function') {
        window.ModuleRegistry.register('004-shortcut-manager', '2026.07.04.0', instance);
