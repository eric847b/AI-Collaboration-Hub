...
// @description  AI Chat Userscript Suite - Auto-organizing content groups
...
/**
 * smart-collections
 * Auto-organizing content groups
 *
 * Part of the AI Chat Userscript Suite.
 */
(() => {
    'use strict';
    const MODULE_NAME = 'smart-collections';
    const metadata = { name: MODULE_NAME, version: '2026.09.02.0', dependencies: [], critical: false, category: '18-Organization' };
