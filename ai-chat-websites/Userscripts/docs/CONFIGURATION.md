...
- **Streaming**: Real-time response streaming (v1.2.0+)
...
- **Streaming Settings**: Real-time response configuration (v1.2.0+)
...
*This configuration guide is maintained as part of the AI Chat Websites userscript collection.*