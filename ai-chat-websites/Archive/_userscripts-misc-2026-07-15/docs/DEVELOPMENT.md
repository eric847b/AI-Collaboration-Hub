...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/ai-rmd/userscripts.git
   cd userscripts
   ```
...
_This development guide is part of the comprehensive refinement plan to improve maintainability and user experience._
